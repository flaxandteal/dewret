...
def test_render_level_4_workflow_outputs_list_in_order() -> None:
    ...
    assert rendered_level_1 == yaml.safe_load("""
        {
        "cwlVersion": 1.2,
        "class": "Workflow",
        "inputs": {},
    ...
    assert rendered_level_2 == yaml.safe_load("""
        {
        "cwlVersion": 1.2,
        "class": "Workflow",
        "inputs": {},
    ...
    assert rendered_level_3 == yaml.safe_load("""
        {
        "cwlVersion": 1.2,
        "class": "Workflow",
        "inputs": {},
    ...
    assert rendered_level_4 == yaml.safe_load("""
        {
        "cwlVersion": 1.2,
        "class": "Workflow",
        "inputs": {},
