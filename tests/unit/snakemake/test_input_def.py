...
def test_input_definition_from_step():
    ...
    step = MockBaseStep(arguments={
        'input1': ref1,
        'param1': MockRaw('str|default'),
        'input2': ref2
    })
...
def test_input_definition_render():
    input_def = InputDefinition(
        ...
        params=['input1=rules.step1.output_file,', 'param1=str|default', 'input2=rules.step2.output_file']
    )
...
def test_input_definition_multiple():
    ...
    assert input_def2.params == ['param1="value1",', 'param2=rules.ref2.output_file,', 'param3="value2"']
