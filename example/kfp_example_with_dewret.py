...
def pipeline() -> Dataset:
    ...
    X_train_artifact, X_test_artifact, y_train_artifact, y_test_artifact = train_test_split(input_df=out_data)
    ...
    return evaluate(y_test= y_test_artifact, predictions=predicted_value)  # Fixed typo here
